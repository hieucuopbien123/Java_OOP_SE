...
// Dùng Dùng ThreadPool và ArrayBlockingQueue: cũng chỉ là 1 cách quản lý nhiều Thread tốt hơn
...
public class LearnPool implements Runnable {
    ...
    public static void main(String[] args) {
        ...
        //nó luôn trong trạng thái chờ nhiệm vụ tiếp theo nên chương trình sẽ k kết thúc
